...
<!-- MENU SECTION -->
<div class="w-full text-left  py-3 relative">
  <!-- CLOSE BUTTON -->
<div class="text-white absolute right-2 -top-2 lg:hidden" @click="TOGGLE_MOBILE_MENU()">
...
export default {
   ...
   data(){
    ...
    methods: {
    ...mapMutations(['TOGGLE_MOBILE_MENU'])
    },
    mounted() {
      console.log(this.openMobileMenu);
    }
}
</script>
